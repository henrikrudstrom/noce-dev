...
#define SWIGTYPE_p_TopoDS_Face swig_types[0]
...
#define SWIGV8_INIT mesh_initialize
...
static SwigV8ReturnValue _wrap_tesselate(const SwigV8Arguments &args) {
  SWIGV8_HANDLESCOPE();
  ...
  if (!SWIG_IsOK(res1)) {
    SWIG_exception_fail(SWIG_ArgError(res1), "in method '" "tesselate" "', argument " "1"" of type '" "TopoDS_Face const &""'"); 
  }
  if (!argp1) {
...
static swig_type_info _swigt__p_TopoDS_Face = {"_p_TopoDS_Face", "TopoDS_Face *", 0, 0, (void*)0, 0};
...
SWIGV8_AddStaticFunction(exports_obj, "tesselate", _wrap_tesselate);
...
NODE_MODULE(mesh, mesh_initialize)
#endif
